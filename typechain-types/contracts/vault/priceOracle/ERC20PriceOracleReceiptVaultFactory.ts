...
export type ERC20PriceOracleVaultConfigStruct = {
  priceOracle: PromiseOrValue<string>;
  vaultConfig: VaultConfigStruct;
};

export type ERC20PriceOracleVaultConfigStructOutput = [
  string,
  VaultConfigStructOutput
] & { priceOracle: string; vaultConfig: VaultConfigStructOutput };

export interface ERC20PriceOracleReceiptVaultFactoryInterface
  ...
  encodeFunctionData(
    ...
    values: [ReceiptConfigStruct, ERC20PriceOracleVaultConfigStruct]
  ): string;
  encodeFunctionData(
...
export interface ERC20PriceOracleReceiptVaultFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC20PriceOracleReceiptVaultFactoryInterface;
  ...
  functions: {
    ...
    createChildTyped(
      ...
      erc20PriceOracleVaultConfig_: ERC20PriceOracleVaultConfigStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
