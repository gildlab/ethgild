...
export interface TwoPriceOracleFactoryInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [TwoPriceOracleConfigStruct]
  ): string;
  encodeFunctionData(
...
export interface TwoPriceOracleFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TwoPriceOracleFactoryInterface;
