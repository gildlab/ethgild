...
contract ERC20PriceOracleReceiptVaultDepositTest is ERC20PriceOracleReceiptVaultTest {
    ...
    function testDeposit(
        ...
        assets = bound(assets, 1, asset.totalSupply());
        console.log("bla bla bla1 ",asset.totalSupply());
        ...
        vm.prank(alice);
        console.log("blaaaaaaaa",expectedShares);

        asset.increaseAllowance(address(vault), asset.totalSupply());

        vault.deposit(1000, alice, oraclePrice, data);
    }
