...
contract TwoPriceOracleTest is Test {
    ...
    function testZeroAddressBase(address quote) public {
        ...
        TwoPriceOracleConfigV2 memory config = TwoPriceOracleConfigV2({
            base: IPriceOracleV2(payable(0)),
            quote: IPriceOracleV2(payable(quote))
        });
    ...
    function testZeroAddressQuote(address base) public {
        ...
        TwoPriceOracleConfigV2 memory config = TwoPriceOracleConfigV2({
            base: IPriceOracleV2(payable(base)),
            quote: IPriceOracleV2(payable(0))
        });
