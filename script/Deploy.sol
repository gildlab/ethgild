...
import {ERC20PriceOracleReceiptVaultFactory, ReceiptVaultFactoryConfig} from "contracts/vault/priceOracle/ERC20PriceOracleReceiptVaultFactory.sol";
...
contract Deploy is Script {
    function deployOwnableOracleVault(uint256 deploymentKey) internal {
        ERC20PriceOracleReceiptVaultFactory factory = ERC20PriceOracleReceiptVaultFactory(vm.envAddress("ERC20_PRICE_ORACLE_RECEIPT_VAULT_FACTORY"));
        ...
        factory.createChild(abi.encode(ERC20PriceOracleVaultConfig({
    ...
    function deployOracleVaultFactory(uint256 deploymentKey) internal {
        ...
        ERC20PriceOracleReceiptVaultFactory factory = new ERC20PriceOracleReceiptVaultFactory(ReceiptVaultFactoryConfig({
