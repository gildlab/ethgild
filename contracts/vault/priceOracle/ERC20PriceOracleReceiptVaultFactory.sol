...
contract ERC20PriceOracleReceiptVaultFactory is ReceiptVaultFactory {
    ...
    function createChildTyped(ERC20PriceOracleVaultConfig memory erc20PriceOracleVaultConfig_)
        external
        returns (ERC20PriceOracleReceiptVault)
    {
        return ERC20PriceOracleReceiptVault(createChild(abi.encode(erc20PriceOracleVaultConfig_)));
    }
}
